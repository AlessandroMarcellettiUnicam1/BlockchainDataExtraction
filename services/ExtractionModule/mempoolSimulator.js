...
async function getSequentialMempoolTxs(url, limit = 100) {
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            async function processQueue() {
                ...
                // Se la coda si svuota ma non abbiamo ancora raggiunto il limite,
                // ci spegniamo e aspettiamo che il Collettore ci riaccenda al prossimo hash.
                isProcessing = false;
            }
